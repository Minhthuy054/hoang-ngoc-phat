...
<div class="ajax-div">
    ...
    <div class="member-search-filter">
        ...
        ?>
        <ul>
            <li><a onclick="wp_dp_member_alphanumaric_ajax('alphanumaric', '', '<?php echo esc_html($member_short_counter); ?>');" href="javascript:void(0);"><?php echo wp_dp_plugin_text_srt('wp_dp_options_all'); ?></a></li>
            <li><a onclick="wp_dp_member_alphanumaric_ajax('alphanumaric', 'numeric', '<?php echo esc_html($member_short_counter); ?>');" href="javascript:void(0);">#</a></li> 
            <?php
            ...
            foreach ($alphas_arr as $char) {
                ...
                <li class="sorting-letter">
                    <?php
                    echo '<a onclick="wp_dp_member_alphanumaric_ajax(\'alphanumaric\', \'' . ($char) . '\', \'' . ($member_short_counter) . '\');" href="javascript:void(0)">
                        ' . $char . '</a>';
                    ?>
                </li>
                <?php
    ...
    <div class="member-listing member-alphabatic">
        <div class="row">
            <?php
