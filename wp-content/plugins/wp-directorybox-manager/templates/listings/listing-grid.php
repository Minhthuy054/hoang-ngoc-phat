...
$listings_excerpt_length = isset($atts['listings_excerpt_length']) ? $atts['listings_excerpt_length'] : '10';
...
$wp_dp_listings_title_limit = isset($atts['listings_title_limit']) ? $atts['listings_title_limit'] : '10';
// start ads script
                                            ...
                                            <div class="caption-inner">
                                                <ul class="dp-listing-options">
                                                    ...
                                                    $book_mark_args = array(
                                                        'before_html' => '<li class="listing-like-opt"><div class="option-holder32">',
                                                        'after_html' => '</div></li>',
                                                        'before_label' => '',
                                                        'after_label' => '',
                                    ...
                                    <figcaption>
                                        ...
                                        <div class="caption-inner">
                                            <ul class="dp-listing-options">
                                                ...
                                                $figcaption_div = true;
                                                $book_mark_args = array(
                                                    'before_html' => '<li class="listing-like-opt"><div class="option-holder1">',
                                                    'after_html' => '</div></li>',
                                                    'before_label' => '',
                                                    'after_label' => '',
                                                    'before_icon' => 'icon-heart-o',
