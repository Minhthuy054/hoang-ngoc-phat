...
$wp_dp_listings_title_limit = isset($atts['filters_listings_title_limit']) ? $atts['filters_listings_title_limit'] : '20';
// start ads script
...
if ( $listing_view === 'v2' ) {
    $main_class = 'listing-grid modern ' . $listing_view;
} else {
    $main_class = 'listing-grid ' . $listing_view;
}
                        ...
                        <figure>
                            ...
                            <figcaption>
                                ...
                                <div class="caption-inner">
                                    <?php if ( $wp_dp_listing_type_price_switch == 'on' && $wp_dp_listing_price != '' && $listing_view == 'v2' ) { ?>
					        ...
					        $listing_info_price = wp_dp_listing_price($listing_id, $wp_dp_listing_price, '<span class="price" content="' . $wp_dp_listing_price . '" itemprop="price">', '</span>', '<span class="special-price" content="" itemprop="price">', '</span>');
                                    ...
                                    <ul class="dp-listing-options">
                                        ...
                                        //
                                        do_action('wp_dp_listing_compare', $listing_id, $compare_listing_switch, 'no', '<li class="listing-compare-opt"><div class="option-holder">', '</div></li>');
                                        $figcaption_div = true;
                                        ...
                                        if ( $listing_video_url != '' && $wp_dp_video_element == 'on') {
                                            ?>
                        ...
                        if ( $listing_view == 'v2' ) {
                            ...
                            if ( ! empty($get_listing_location) ) {
                                ...
                                <ul class="listing-location">
                                    <li><i class="icon-location-pin2"></i> <?php echo esc_html(implode(' / ', $get_listing_location)); ?></li>
                                </ul>
                            <?php } ?>
                            <div class="post-title">
                                <h4><a href="<?php echo esc_url(get_permalink($listing_id)); ?>"><?php echo (wp_dp_limit_text(get_the_title($listing_id), $wp_dp_listings_title_limit)) ?></a></h4>
                            </div>
                            <?php
