        ...
        <div class="search-default-fields">
			...
			<?php if ( $listingsearch_location_switch == 'yes' ) { ?>
				<div class="field-holder search-input">
					...
					wp_dp_get_custom_locations_listing_filter( '<div id="wp-dp-fancy-v2-select-holder" class="search-country" style="display:' . wp_dp_allow_special_char( $wp_dp_select_display ) . '"><div class="select-holder">', '</div></div>', false, $listing_short_counter );
					?>
				</div>
				<?php
			}
