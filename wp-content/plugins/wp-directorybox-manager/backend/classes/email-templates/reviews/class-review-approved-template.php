 ...
 */
if ( ! class_exists( 'Wp_dp_review_approved_email_template' ) ) {

	class Wp_dp_review_approved_email_template {
		...
		public function __construct() {
			...
			$this->email_template_index = 'review-approved-template';
			...
			add_action( 'wp_dp_review_approved_email', array( $this, 'wp_dp_review_approved_email_callback' ), 10, 2 );
		}

		public function wp_dp_review_approved_email_callback( $user = '', $review_id = '' ) {
			...
			$reciever_email = $this->get_review_added_email();
			...
			if ( isset( $template['email_notification'] ) && $template['email_notification'] == 1 ) {
				...
				$subject = (isset( $template['subject'] ) && $template['subject'] != '' ) ? $template['subject'] : wp_dp_plugin_text_srt( 'wp_dp_review_approved_notification' );
				...
				Wp_dp_review_approved_email_template::$is_email_sent1 = $this->is_email_sent;
			}
		}
	...
	new Wp_dp_review_approved_email_template();
}
