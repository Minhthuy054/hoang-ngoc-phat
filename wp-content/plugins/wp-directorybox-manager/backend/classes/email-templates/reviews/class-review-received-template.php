 ...
 */
if ( ! class_exists( 'Wp_dp_review_received_email_template' ) ) {

	class Wp_dp_review_received_email_template {
		...
		public function __construct() {
			$this->user = array();
			$this->email_template_type = 'Review Received Notification For Listing Owner';

			$this->email_default_template = '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8" /><meta name="viewport" content="width=device-width, initial-scale=1.0"/></head><body style="margin: 0; padding: 0;"><div style="background-color: #eeeeef; padding: 50px 0;"><table style="max-width: 640px;" border="0" cellspacing="0" cellpadding="0" align="center"><tbody><tr><td style="padding: 40px 30px 30px 30px;" align="center" bgcolor="#33333e"><h1 style="color: #fff;">Review Received Notification For Listing Owner</h1></td></tr><tr><td bgcolor="#ffffff" style="padding: 40px 30px 40px 30px;"><table border="0" cellpadding="0" cellspacing="0" width="100%"><tr><td width="260" valign="top"><table border="0" cellpadding="0" cellspacing="0" width="100%"><tr><td style="padding-bottom: 8px;">Dear [LISTING_OWNER_NAME]</td></tr><tr><td style="padding-bottom: 8px;">Thank you for working with [SITE_NAME]. A review has been received against your listing. Below is detail of review;</td></tr><tr><td style="padding-bottom: 8px;">[REVIEW_LISTING_TITLE]</td></tr><tr><td style="padding-bottom: 8px;">You can reply this review from user dashboard.</td></tr></table></td></tr></table></td></tr><tr><td style="background-color: #ffffff; padding: 30px 30px 30px 30px;"><table border="0" width="100%" cellspacing="0" cellpadding="0"><tbody><tr><td style="font-family: Arial, sans-serif; font-size: 14px;">&reg; [SITE_NAME], 2017</td></tr></tbody></table></td></tr></tbody></table></div></body></html>';
			...
			$this->email_template_index = 'review-received-template';
			...
			add_action( 'wp_dp_review_received_email', array( $this, 'wp_dp_review_received_email_callback' ), 10, 2 );
		}

		public function wp_dp_review_received_email_callback( $user = '', $review_id = '' ) {
			...
			if ( isset( $template['email_notification'] ) && $template['email_notification'] == 1 ) {
				...
				$subject = (isset( $template['subject'] ) && $template['subject'] != '' ) ? $template['subject'] : wp_dp_plugin_text_srt( 'wp_dp_review_received_notification' );
				...
				Wp_dp_review_received_email_template::$is_email_sent1 = $this->is_email_sent;
			}
		}
		...
		public function add_email_template() {
			...
			$email_templates[$this->template_group][$this->email_template_index] = array(
				...
				'description' => wp_dp_plugin_text_srt( 'wp_dp_review_added_email' ),
				'jh_email_type' => 'html',
			);
		...
		function get_review_added_user_name() {
			$review_user_name = '';
			$company_id = get_post_meta( $this->review_id, 'company_id', true );
			$review_user_name = esc_html(get_the_title( $company_id ));
		...
		function get_review_added_email() {
			...
			$member_id = get_post_meta( $this->review_id, 'company_id', true ); 
			if ( isset( $member_id ) && $member_id != '' ) {
				$member_email = get_post_meta( $member_id, 'wp_dp_email_address', true );
			}
	...
	new Wp_dp_review_received_email_template();
}
