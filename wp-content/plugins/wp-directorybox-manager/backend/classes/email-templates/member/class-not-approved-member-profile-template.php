 ...
 */
if ( ! class_exists( 'Wp_dp_not_approved_member_profile_template' ) ) {

	class Wp_dp_not_approved_member_profile_template {
		...
		public function __construct() {
			...
			$this->email_template_type = 'Pending Profile Notification to User';
			...
			$this->email_template_variables = array(
				...
				array(
					...
					'value_callback' => array( $this, 'get_not_approved_member_email' ),
				)
				...
				if ( $role == 'wp_dp_member' ) {
					...
					if ( $member_status != 'active' && ($member_status != $member_old_status || $member_old_status == '') ) {
						...
						if ( isset( $template['email_notification'] ) && $template['email_notification'] == 1 ) {
							...
							$subject = (isset( $template['subject'] ) && $template['subject'] != '' ) ? $template['subject'] : wp_dp_plugin_text_srt( 'wp_dp_not_approved_member_email_subject' );
		...
		public function add_email_template() {
			...
			$email_templates[$this->template_group][$this->email_template_index] = array(
				...
				'description' => wp_dp_plugin_text_srt( 'wp_dp_not_approved_member_email' ),
				'subject' => wp_dp_plugin_text_srt( 'wp_dp_not_approved_member_email_subject' ),
				'jh_email_type' => 'html',
			);
							...
							<tbody>
								<tr>
									<td style="padding: 40px 30px 30px 30px;" align="center" bgcolor="#33333e">
										<h1 style="color: #fff;">Pending Profile Notification to User</h1>
									</td>
								</tr>
								<tr>
											...
											<tr>
												<td width="260" valign="top">
													<table border="0" cellpadding="0" cellspacing="0" width="100%">
														...
														<tr>
															<td style="padding-bottom: 8px;">Thank you for registering with [SITE_NAME]. Your profile is pending approval. Once it is approved, you will be notified via email.</td>
														</tr>
														<tr>
	...
	new Wp_dp_not_approved_member_profile_template();
}