...
if ( ! class_exists( 'Wp_dp_sent_order_email_template' ) ) {

	class Wp_dp_sent_order_email_template {
		...
		public function __construct() {
			...
			add_action( 'wp_dp_sent_order_email', array( $this, 'wp_dp_sent_order_email_callback' ), 10, 4 );
		}

		public function wp_dp_sent_order_email_callback( $order_id = '' ) {
			...
			if ( isset( $template['email_notification'] ) && $template['email_notification'] == 1 ) {
				...
				$subject = (isset( $template['subject'] ) && $template['subject'] != '' ) ? $template['subject'] : wp_dp_plugin_text_srt( 'wp_dp_sent_order' );
				...
				Wp_dp_sent_order_email_template::$is_email_sent1 = $this->is_email_sent;
			}
		}
		...
		public function add_email_template() {
			...
			$email_templates[$this->template_group][$this->email_template_index] = array(
				...
				'description' => wp_dp_plugin_text_srt( 'wp_dp_sent_order_email' ),
				'jh_email_type' => 'html',
			);
	...
	new Wp_dp_sent_order_email_template();
}
