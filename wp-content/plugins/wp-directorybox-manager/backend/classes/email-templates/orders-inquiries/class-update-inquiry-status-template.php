...
if ( ! class_exists( 'Wp_dp_inquiry_status_updated_email_template' ) ) {

	class Wp_dp_inquiry_status_updated_email_template {
		...
		public function __construct() {
			...
			add_action( 'wp_dp_inquiry_status_updated_email', array( $this, 'wp_dp_inquiry_status_updated_email_callback' ), 10, 4 );
		}

		public function wp_dp_inquiry_status_updated_email_callback( $inquiry_id = '' ) {
			...
			if ( isset( $template['email_notification'] ) && $template['email_notification'] == 1 ) {
				...
				$subject = (isset( $template['subject'] ) && $template['subject'] != '' ) ? $template['subject'] : wp_dp_plugin_text_srt( 'wp_dp_update_inquiry' );
				...
				Wp_dp_inquiry_status_updated_email_template::$is_email_sent1 = $this->is_email_sent;
			}
		}
	...
	new Wp_dp_inquiry_status_updated_email_template();
}
