...
/**
 * User Favourite Listing Email Template
 *
 * @since 1.0
 * @package Directory Box
 */
if (!class_exists('Wp_dp_favourite_listing_email_template')) {

    class Wp_dp_favourite_listing_email_template {
        ...
        public function __construct() {
            ...
            $this->email_template_type = 'Favourite Listing Received Notification for Listing Owner';
            ...
            $this->email_template_variables = array(
                array(
                    'tag' => 'USER_NAME',
                    'display_text' => 'Favourite Username',
                    'value_callback' => array($this, 'get_favourite_user_name'),
                ),
                array(
                    'tag' => 'USER_EMAIL',
                    'display_text' => 'Favourite User Email',
                    'value_callback' => array($this, 'get_favourite_user_email'),
                ),
				array(
                    'tag' => 'USER_PROFILE_LINK',
                    'display_text' => 'Favourite User Profile Link',
                    'value_callback' => array($this, 'get_favourite_user_profile_link'),
                ),
                array(
            ...
            $this->email_template_index = 'user-favourite-listing-template';
            ...
            add_action('wp_dp_received_favourite_listing_email', array($this, 'wp_dp_received_favourite_listing_email_callback'), 10, 1);
        }

        public function wp_dp_received_favourite_listing_email_callback($form_fields = array()) {
            ...
            if (isset($template['email_notification']) && $template['email_notification'] == 1) {
                ...
                $subject = (isset($template['subject']) && $template['subject'] != '' ) ? $template['subject'] : wp_dp_plugin_text_srt('wp_dp_received_listing_favourite_email_subject');
                $from = (isset($template['from']) && $template['from'] != '') ? $template['from'] : esc_attr($this->get_favourite_user_name()) . ' <' . $this->get_favourite_user_email() . '>';
                ...
                Wp_dp_favourite_listing_email_template::$is_email_sent1 = $this->is_email_sent;
            }
        }
        ...
        public function add_email_template() {
            ...
            $email_templates[$this->template_group][$this->email_template_index] = array(
                ...
                'description' => wp_dp_plugin_text_srt('wp_dp_received_listing_favourite_description'),
				'subject' => wp_dp_plugin_text_srt('wp_dp_received_listing_favourite_email_subject'),
                'jh_email_type' => 'html',
            );
        ...
        function get_favourite_user_name() {
            return isset($this->form_fields['user_name']) ? $this->form_fields['user_name'] : '';
        }
        public function get_favourite_user_profile_link(){
            return isset($this->form_fields['user_url']) ? $this->form_fields['user_url'] : '';
        }
        function get_favourite_user_email() {
            $member_id =  isset($this->form_fields['member_id']) ? $this->form_fields['member_id'] : '';
            $listing_member_email = get_post_meta($member_id, 'wp_dp_email_address', true);
            return $listing_member_email;
        }  
        function get_listing_user_name() {
            $wp_dp_listing_id = isset($this->form_fields['listing_id']) ? $this->form_fields['listing_id'] : '';
        ...
        function get_listing_title() {
            $listing_id = isset($this->form_fields['listing_id']) ? $this->form_fields['listing_id'] : '';
                                            ...
                                            <tbody>
                                                    <tr>
                                                            <td style="padding: 40px 30px 30px 30px;" align="center" bgcolor="#33333e">
                                                                    <h1 style="color: #fff; line-height: 28px;">Favourite Listing Received Notification for Listing Owner</h1>
                                                            </td>
                                                    </tr>
                                                    <tr>
                                                                    ...
                                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                            <tr>
                                                                                    <td width="260" valign="top">
                                                                                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                                                    <tr>
                                                                                                            <td style="padding-bottom: 8px;">Dear [LISTING_USER_NAME]</td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                            <td style="padding-bottom: 8px;">Thank you for working with [SITE_NAME]. A new user has favourite your listing. Below is the detail of favourite listing user;</td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                    ...
                                                                                                    <tr>
                                                                                                            <td style="padding-bottom: 8px;">User Profile Link: [USER_PROFILE_LINK]</td>
                                                                                                    </tr>
                                                                                                    <tr>
    ...
    new Wp_dp_favourite_listing_email_template();
}
