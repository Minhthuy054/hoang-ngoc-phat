<?php
/**
 * Received Listing Claim Email Template
 *
 * @since 1.0
 * @package	Directory Box
 */
if ( ! class_exists( 'Wp_dp_listing_claim_email_template' ) ) {

	class Wp_dp_listing_claim_email_template {
		...
		public function __construct() {
			...
			$this->email_template_type = 'Claim Listing Received Notification to Administrator';
			...
			add_action( 'wp_dp_received_claim_email', array( $this, 'wp_dp_received_claim_email_callback' ), 10, 1 );
		}

		public function wp_dp_received_claim_email_callback( $form_fields = array() ) {
			...
			if ( isset( $template['email_notification'] ) && $template['email_notification'] == 1 ) {
				...
				$subject = (isset( $template['subject'] ) && $template['subject'] != '' ) ? $template['subject'] : wp_dp_plugin_text_srt( 'wp_dp_received_listing_claim_email_subject' );
				...
				Wp_dp_listing_claim_email_template::$is_email_sent1 = $this->is_email_sent;
			}
		}
		...
		public function add_email_template() {
			...
			$email_templates[$this->template_group][$this->email_template_index] = array(
				...
				'description' => wp_dp_plugin_text_srt( 'wp_dp_received_listing_claim_email' ),
				'subject' => wp_dp_plugin_text_srt( 'wp_dp_received_listing_claim_email_subject' ),
				'jh_email_type' => 'html',
			);
		...
		function get_claim_user_name() {
			return isset( $this->form_fields['wp_dp_claim_listing_user_name'] ) ? $this->form_fields['wp_dp_claim_listing_user_name'] : '';
		}

		function get_claim_user_email() {
			return isset( $this->form_fields['wp_dp_claim_listing_user_email'] ) ? $this->form_fields['wp_dp_claim_listing_user_email'] : '';
		}

		function get_claim_user_reason() {
			return isset( $this->form_fields['wp_dp_claim_listing_reason'] ) ? $this->form_fields['wp_dp_claim_listing_reason'] : '';
		}
		...
		function get_listing_user_name() {
			$wp_dp_listing_id = isset( $this->form_fields['wp_dp_claim_listing_id'] ) ? $this->form_fields['wp_dp_claim_listing_id'] : '';
		...
		function get_listing_title() {
			$listing_id = isset( $this->form_fields['wp_dp_claim_listing_id'] ) ? $this->form_fields['wp_dp_claim_listing_id'] : '';
							...
							<tbody>
								<tr>
									<td style="padding: 40px 30px 30px 30px;" align="center" bgcolor="#33333e">
										<h1 style="color: #fff;">Claim Listing Received Notification to Administrator</h1>
									</td>
								</tr>
								<tr>
										...
										<table border="0" cellpadding="0" cellspacing="0" width="100%">
											<tr>
												<td width="260" valign="top">
													<table border="0" cellpadding="0" cellspacing="0" width="100%">
														<tr>
															<td style="padding-bottom: 8px;">A new claim listing has been received on your site. Below are the details of claim listing;</td>
														</tr>
														<tr>
															<td style="padding-bottom: 8px;">Listing Title: <a href="[LISTING_LINK]">[LISTING_TITLE]</a></td>
														</tr>
														<tr>
															<td style="padding-bottom: 8px;">Name: [CLAIM_USER_NAME]</td>
														</tr>
														<tr>
															<td style="padding-bottom: 8px;">Email: [CLAIM_USER_EMAIL]</td>
														</tr>
														<tr>
															<td style="padding-bottom: 8px;">Reason: [CLAIM_REASON]</td>
														</tr>
														<tr>
	...
	new Wp_dp_listing_claim_email_template();
}
