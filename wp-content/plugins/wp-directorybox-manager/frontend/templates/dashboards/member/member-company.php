 ...
 *
 */
if ( ! class_exists('Wp_dp_Member_Member') ) {

    class Wp_dp_Member_Member {
        ...
        public function __construct() {
            ...
            //add_action('wp_ajax_wp_dp_update_branch', array( $this, 'wp_dp_update_branch_callback' ), 11);
            //add_action('wp_ajax_wp_dp_remove_branch', array( $this, 'wp_dp_remove_branch_callback' ), 11);
        }

        /**
         * Member Member Form
         */
        public function wp_dp_member_company_callback($member_id = '') {
            ...
            $phone_number = get_post_meta($post->ID, 'wp_dp_phone_number', true);

            $company_ID = get_user_meta(get_current_user_id(), 'wp_dp_company', true);
            $team_args = array(
                'role' => 'wp_dp_member',
                'meta_query' => array(
                    array(
                    ...
                    <div class="user-profile">
                        <div class="element-title<?php echo wp_dp_allow_special_char($has_border); ?>">
                            ...
                            <div class="team-option">
                                <a href="javascript:void(0);" class="add-more add_team_member"><?php echo wp_dp_plugin_text_srt('wp_dp_member_add_members'); ?></a>
                            </div>
                        </div>
                        <div class="row">
                                        ...
                                        <div class="invite-member-popup">   
                                            <form id="team_add_form" method="POST" enctype="multipart/form-data">
                                                <div class ="element-title has-border">
                                                    ...
                                                    <h4><?php echo wp_dp_plugin_text_srt('wp_dp_member_add_team_member'); ?></h4>
                                                </div>
                                                <div class="row team-fields">
                                                    ...
                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                        <div class="field-holder">
                                                            ...
                                                            <?php
                                                            $wp_dp_opt_array = array(
                                                                'name' => wp_dp_plugin_text_srt('wp_dp_member_email_address'),
                                                                'desc' => '',
                                                                'echo' => true,
                                                                'field_params' => array(
                                                                    'std' => '',
                                                    ...
                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                        <div class="field-holder">
                                                            ...
                                                            <?php
                                                            $wp_dp_opt_array = array(
                                                                'name' => wp_dp_plugin_text_srt('wp_dp_member_phone_number'),
                                                                'desc' => '',
                                                                'echo' => true,
                                                                'field_params' => array(
                                                                    'std' => '',
                                                        ...
                                                        <div class="field-holder profile-image-field">
                                                            ...
                                                            $wp_dp_opt_array = array(
                                                                ...
                                                                'field_params' => array(
                                                                    'std' => '',
                                                                    'id' => 'member_thumb_1',
                                                                    'extra_atr' => 'data-id="1" class="wp-dp-member-thumb" style="display:none;"',
                                                            ...
                                                            <div class="upload-file"><button for="file-1" class="member-thumbnail-upload" data-id="1" type="button"><span><?php echo wp_dp_plugin_text_srt('wp_dp_member_upload'); ?></span></button></div>
                                                    ...
                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                        <div class="field-holder">
                                                            ...
                                                            $wp_dp_opt_array = array(
                                                                'name' => wp_dp_plugin_text_srt('wp_dp_member_public_profile'),
                                                                'desc' => '',
                                                                'echo' => true,
                                                                'field_params' => array(
                                                                    'std' => '',
                                                    ...
                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                        <div class="field-holder">
                                                            ...
                                                            $wp_dp_opt_array = array(
                                                                'name' => wp_dp_plugin_text_srt('wp_dp_member_user_type'),
                                                                'desc' => '',
                                                                'echo' => true,
                                                                'field_params' => array(
                                                                    'std' => '',
                                                                    ...
                                                                    'classes' => 'chosen-select-no-single',
                                                                    'options' => $user_type,
                                                                    'extra_atr' => 'onchange="wp_dp_user_permission(this, \'add_member_permission\', \'supper-admin\');"'
                                                                ),
                                                            );
                                                            $wp_dp_html_fields_frontend->wp_dp_form_select_render($wp_dp_opt_array);
                                                            ?>
                                                        ...
                                                        <ul class = "checkbox-list">
                                                            ...
                                                            foreach ( $permissions_array as $permission_key => $permission_value ) {
                                                                ...
                                                                <li class = "col-lg-6 col-md-6 col-sm-12 col-xs-12" draggable = "true" style = "display: inline-block;">
                                                                    ...
                                                                    $wp_dp_html_fields_frontend->wp_dp_form_checkbox_render($wp_dp_opt_array);
                                                                    ?>
                                                                </li>
                                                            <?php } ?>
                                                        </ul>
                                                    ...
                                                    <div class = "col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                        <div class = "field-holder">
                                                            <a href="javascript:;" id="add_member" class="btn-send"><?php echo wp_dp_plugin_text_srt('wp_dp_member_send'); ?></a>
                                                            <a href = "javascript:void(0);" class = "cancel"><?php echo wp_dp_plugin_text_srt('wp_dp_member_cancel'); ?></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </form>
                                        ...
                                        if ( isset($team_members) && $team_members != '' && sizeof($team_members) > 0 ) {
                                            ...
                                            <ul class="panel-group">
                                                ...
                                                foreach ( $team_members as $member_data ) {
                                                    ...
                                                    $wp_dp_member_thumb_id = get_user_meta($member_data->ID, 'member_thumb', true);
                                                    ...
                                                    <li>
                                                        <div class="panel panel-default" >
                                                            <form name="wp_dp_update_team_member" id="wp_dp_update_team_member<?php echo esc_attr($member_data->ID); ?>" data-selected_user_type="<?php echo esc_attr($selected_user_type); ?>" data-count_supper_admin="<?php echo esc_attr($supper_admin_count); ?>" data-id="<?php echo esc_attr($member_data->ID); ?>" method="POST">
                                                                ...
                                                                <div id="team-member-det-<?php echo esc_attr($member_data->ID); ?>" class="invite-member team-member-det-box">
                                                                    <div class="invite-member-popup">
                                                                        ...
                                                                        <div class="element-title has-border">
                                                                            <a href="javascript:void(0);" class="close-btn cancel">&times;</a>
                                                                            <h4><?php echo wp_dp_plugin_text_srt('wp_dp_members_company_update_team_member'); ?></h4>
                                                                        </div>
                                                                        <div class="row">
                                                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                                <div class="field-holder">
                                                                                ...
                                                                                <div class="field-holder profile-image-field">
                                                                                    ...
                                                                                    $wp_dp_opt_array = array(
                                                                                        ...
                                                                                        'field_params' => array(
                                                                                            ...
                                                                                            'extra_atr' => 'data-id="' . $member_data->ID . '" class="wp-dp-member-thumb" style="display:none;"',
                                                                                            'cust_name' => 'wp_dp_member_thumb',
                                                                                            'cust_type' => 'file',
                                                                                        ),
                                                                                    );
                                                                                    ...
                                                                                    <div class="upload-file"><button for="file-1" class="member-thumbnail-upload" data-id="<?php echo esc_attr($member_data->ID); ?>" type="button"><span><?php echo wp_dp_plugin_text_srt('wp_dp_members_company_upload'); ?></span></button></div>
                                                                            ...
                                                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                                <button name="button" class="btn-submit team-update-button-<?php echo esc_attr($rand); ?>" data-id="<?php echo esc_attr($rand); ?>" type="button" id="team_update_form"><?php echo wp_dp_plugin_text_srt('wp_dp_members_company_update'); ?></button>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                            ...
                                            echo '<ul class="panel-group"><li class="no-order-list-found">' . wp_dp_plugin_text_srt('wp_dp_member_no_any_member') . '.</li></ul>';
                                        }
                                        ?>
                                    </div>
                                </div>
        ...
        public function wp_dp_add_team_member_callback() {
            ...
            $user_type = wp_dp_get_input('wp_dp_user_type', NULL, 'STRING');
            $member_name = wp_dp_get_input('wp_dp_member_name', NULL, 'STRING');
            $public_profile = wp_dp_get_input('wp_dp_public_profile', NULL, 'STRING');
            $member_phone_number = wp_dp_get_input('wp_dp_member_phone_number', NULL, 'STRING');
            $member_thumb = isset($_FILES['wp_dp_member_thumb']) ? $_FILES['wp_dp_member_thumb'] : '';
            $user_type = isset($user_type) && $user_type != '' ? $user_type : 'team-member';
            if ( $email == NULL ) {
                $response_array = array(
                    'type' => 'error',
                    'msg' => wp_dp_plugin_text_srt('wp_dp_member_valid_email'),
                );
            ...
            if ( ! is_wp_error($user_ID) ) {
                ...
                update_user_meta($user_ID, 'wp_dp_user_type', $user_type);
                ...
                if ( isset($public_profile) && $public_profile != '' ) {
                    update_user_meta($user_ID, 'wp_dp_public_profile', $public_profile);
                }
                ...
                do_action('wp_dp_add_member_email', $email_array);

                $response_array = array(
                    'type' => 'success',
                    'msg' => wp_dp_plugin_text_srt('wp_dp_member_member_added'),
                );
                echo json_encode($response_array);
        ...
        public function wp_dp_update_team_member_callback() {
            ...
            if ( $update_allow == 1 ) {
                ...
                if ( isset($_POST['update_from_admin']) && $_POST['update_from_admin'] == 1 ) {
                    $member_thumb_id = $_POST['wp_dp_member_thumb_' . $user_ID];
                    if ( $member_thumb_id != '' ) {
        ...
        public function wp_dp_update_branch_callback() {
            $branch_id = wp_dp_get_input('branch_id', NULL, 'INT');

            $branch_name = wp_dp_get_input('wp_dp_branch_name', NULL, 'STRING');
            update_post_meta($branch_id, 'wp_dp_branch_name', $branch_name);

            $phone_number = wp_dp_get_input('wp_dp_phone_number', NULL, 'STRING');
            update_post_meta($branch_id, 'wp_dp_branch_phone', $phone_number);

            $wp_dp_email_address = wp_dp_get_input('wp_dp_email_address', NULL, 'STRING');
            update_post_meta($branch_id, 'wp_dp_branch_email', $wp_dp_email_address);

            $wp_dp_branch_address = wp_dp_get_input('wp_dp_branch_address', NULL, 'STRING');
            update_post_meta($branch_id, 'wp_dp_post_loc_address_branch', $wp_dp_branch_address);

            $wp_dp_branch_member = wp_dp_get_input('wp_dp_branch_member', NULL, 'INT');
            update_post_meta($branch_id, 'wp_dp_branch_member', $wp_dp_branch_member);

            $response_array = array(
                'type' => 'success',
                'msg' => wp_dp_plugin_text_srt('wp_dp_member_branch_updated'),
            );
        ...
        public function wp_dp_remove_team_member_callback() {
            ...
            $user_ID = wp_dp_get_input('wp_dp_user_id', NULL, 'INT');
            $wp_dp_user_type = get_user_meta($user_ID, 'wp_dp_user_type', true);
            $count_supper_admin = wp_dp_get_input('count_supper_admin', NULL, 'INT');
            ...
            if ( $wp_dp_user_type == 'supper-admin' ) {
                if ( $count_supper_admin > 1 ) {
                    ...
                    $response_array = array(
                        'type' => 'success',
                        'msg' => wp_dp_plugin_text_srt('wp_dp_member_super_admin_removed'),
                    );
                } else {
                    $response_array = array(
                        'type' => 'error',
            ...
            if ( $wp_dp_user_type == 'team-member' ) {
                update_user_meta($user_ID, 'wp_dp_user_status', 'deleted');
                $response_array = array(
                    'type' => 'success',
        ...
        public function wp_dp_remove_branch_callback() {
            ...
            $response_array = array(
                'type' => 'success',
                'msg' => wp_dp_plugin_text_srt('wp_dp_member_branch_removed'),
            );
    ...
    global $wp_dp_member_company;
    $wp_dp_member_company = new Wp_dp_Member_Member();
}
