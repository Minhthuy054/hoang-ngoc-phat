 ...
 *
 */
if (!class_exists('Wp_dp_Member_Branches')) {

    class Wp_dp_Member_Branches {

        /**
         * Start construct Functions
         */
        public function __construct() {
            add_action('wp_ajax_wp_dp_member_company', array($this, 'wp_dp_member_company_callback'), 11, 1);
            add_action('wp_ajax_wp_dp_remove_member_branch', array($this, 'wp_dp_remove_member_branch_callback'), 11);
            add_action('wp_ajax_wp_dp_member_branch_add', array($this, 'wp_dp_member_branch_add_callback'), 11);
            add_action('wp_ajax_wp_dp_add_update_branch', array($this, 'wp_dp_add_update_branch_callback'), 11);
            add_filter('wp_dp_member_branches_count', array($this, 'wp_dp_member_branches_count_callback'), 11, 1);
        }

        /**
         * How to show location fields in front end
         */
        public function wp_dp_frontend_location_fields($show_map = 'on', $post_id = '', $field_postfix = '', $user = '') {
            ...
            $wp_dp_obj = new wp_dp();
            $wp_dp_obj->wp_dp_branches_location_gmap_script();
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <fieldset class="gllpLatlonPicker_<?php echo esc_html($field_postfix); ?>" style="width:100%; float:left;" id="fe_map<?php echo esc_html($field_postfix); ?>" data-radius="<?php echo absint($radius_circle); ?>" data-radiusshow="<?php echo esc_html($wp_dp_loc_radius); ?>">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="switchs-holder2">
                                            <div class="field-holder">
                                                <label><?php echo wp_dp_plugin_text_srt('wp_dp_tp_members_find_on_map'); ?></label>
                                                <?php
                                                $wp_dp_opt_array = array(
                                                    'name' => '',
                                                    'desc' => '',
                                                    ...
                                                    'field_params' => array(
                                                        ...
                                                        'extra_atr' => 'onkeypress="wp_dp_gl_search_map(this.value)" placeholder="' . wp_dp_plugin_text_srt('wp_dp_member_branches_type_address') . '"',
                                            ...
                                            <div class="row">
                                                <div style="display:none;" class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                    <div class="field-holder">
                                                        ...
                                                        <?php
                                                        $wp_dp_opt_array = array(
                                                            'name' => wp_dp_plugin_text_srt('wp_dp_member_branches_latitude'),
                                                            ...
                                                            'field_params' => array(
                                                                ...
                                                                'extra_atr' => ' placeholder="' . wp_dp_plugin_text_srt('wp_dp_member_branches_latitude') . '"',
                                                ...
                                                <div style="display:none;" class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                    <div class="field-holder">
                                                        ...
                                                        <?php
                                                        $wp_dp_opt_array = array(
                                                            'name' => wp_dp_plugin_text_srt('wp_dp_member_branches_longitude'),
                                                            ...
                                                            'field_params' => array(
                                                                ...
                                                                'extra_atr' => ' placeholder="' . wp_dp_plugin_text_srt('wp_dp_member_branches_longitude'). '"',
                                            ...
                                            <div class="search-location-map input-button-loader">
                                                ...
                                                $wp_dp_opt_array = array(
                                                    ...
                                                    'echo' => true,
                                                    'field_params' => array(
                                                        'std' => wp_dp_plugin_text_srt('wp_dp_member_branches_search_loc'),
                                                        'id' => 'map_search_btn',
                                                        'cust_type' => 'button',
                                        ...
                                        <?php } ?>
                                        <?php if ($show_map == 'on') { ?>
                                            <p> <?php echo wp_dp_plugin_text_srt('wp_dp_tp_members_drag_drop_pin'); ?></p>
                                        <?php } ?>
                                    </div>
                                </div>
                            </div>
        ...
        public function wp_dp_add_update_branch_callback() {
            global $wp_dp_html_fields_frontend, $post, $wp_dp_form_fields_frontend;

            $branch_id = wp_dp_get_input('wp_dp_branch_id', NULL, 'INT');
            $branch_member = wp_dp_get_input('wp_dp_branch_member', NULL, 'INT');
            $branch_name = wp_dp_get_input('wp_dp_branch_name', '', 'STRING');
            $branch_phone = wp_dp_get_input('wp_dp_branch_phone', '', 'STRING');
            $branch_email = wp_dp_get_input('wp_dp_branch_email', '', 'STRING');

            $branch_loc_zoom = wp_dp_get_input('wp_dp_post_loc_zoom_branch', '', 'STRING');
            $branch_loc_address = wp_dp_get_input('wp_dp_post_loc_address_branch', '', 'STRING');
            $branch_loc_latitude = wp_dp_get_input('wp_dp_post_loc_latitude_branch', '', 'STRING');
            $branch_loc_longitude = wp_dp_get_input('wp_dp_post_loc_longitude_branch', '', 'STRING');

            if ($branch_name == '') {
                $response_array = array(
                    'type' => 'error',
                    'msg' => wp_dp_plugin_text_srt('wp_dp_member_branches_prvd_name'),
                );
            } else if ($branch_email == '') {
                $response_array = array(
                    'type' => 'error',
                    'msg' => wp_dp_plugin_text_srt('wp_dp_member_branches_prvd_email'),
                );
            } else if (!is_email($branch_email)) {
                $response_array = array(
                    'type' => 'error',
                    'msg' => wp_dp_plugin_text_srt('wp_dp_member_branches_prvd_vlid_email'),
                );
            } else {
                if ($branch_id == NULL) {
                    $branch_post = array(
                    ...
                    update_post_meta($branch_id, 'wp_dp_branch_member', $branch_member);
                    update_post_meta($branch_id, 'wp_dp_branch_name', $branch_name);
                    update_post_meta($branch_id, 'wp_dp_branch_phone', $branch_phone);
                    update_post_meta($branch_id, 'wp_dp_branch_email', $branch_email);

                    update_post_meta($branch_id, 'wp_dp_post_loc_zoom_branch', $branch_loc_zoom);
                    update_post_meta($branch_id, 'wp_dp_post_loc_address_branch', $branch_loc_address);
                    update_post_meta($branch_id, 'wp_dp_post_loc_latitude_branch', $branch_loc_latitude);
                    update_post_meta($branch_id, 'wp_dp_post_loc_longitude_branch', $branch_loc_longitude);

                    $response_array = array(
                        'type' => 'success',
                        'msg' => wp_dp_plugin_text_srt('wp_dp_member_branches_added_success'),
                    );
                } elseif ($branch_id != '') {
                    $my_branch = array(
                        'ID' => $branch_id,
                    ...
                    $response_array = array(
                        'type' => 'success',
                        'msg' => wp_dp_plugin_text_srt('wp_dp_member_branches_update_success'),
                    );
                }
            }
        ...
        public function wp_dp_member_branch_add_callback() {
            global $wp_dp_html_fields_frontend, $post, $wp_dp_form_fields_frontend;

            $member_id = get_user_meta(get_current_user_id(), 'wp_dp_company', true);
            $branch_id = wp_dp_get_input('wp_dp_branch_id', NULL, 'INT');
            $branch_name = get_post_meta($branch_id, 'wp_dp_branch_name', true);
            $branch_phone = get_post_meta($branch_id, 'wp_dp_branch_phone', true);
            $branch_email = get_post_meta($branch_id, 'wp_dp_branch_email', true);
            ?>
                ...
                <form id="branch_add_form" method="POST">
                    <div class ="element-title has-border">
                        ...
                        <h4>
                            <?php
                            if ($branch_id == NULL) {
                                echo wp_dp_plugin_text_srt('wp_dp_tp_members_ad_branch');
                            } else {
                                echo wp_dp_plugin_text_srt('wp_dp_tp_members_upd_branch');
                            }
                            ?>
                        </h4>
                    </div>
                    <div class="row branch-fields">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="field-holder">
                                <label><?php echo wp_dp_plugin_text_srt('wp_dp_member_branches_name'); ?></label>
                                <?php
                                $wp_dp_opt_array = array(
                                    'name' => wp_dp_plugin_text_srt('wp_dp_member_branches_name'),
                                    'desc' => '',
                                    'echo' => true,
                                    'field_params' => array(
                                        'std' => $branch_name,
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="field-holder">
                                <label><?php echo wp_dp_plugin_text_srt('wp_dp_member_branches_phone'); ?></label>
                                <?php
                                $wp_dp_opt_array = array(
                                    'name' => wp_dp_plugin_text_srt('wp_dp_member_branches_phone'),
                                    'desc' => '',
                                    'echo' => true,
                                    'field_params' => array(
                                        'std' => $branch_phone,
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="field-holder">
                                <label><?php echo wp_dp_plugin_text_srt('wp_dp_member_branches_email'); ?></label>
                                <?php
                                $wp_dp_opt_array = array(
                                    'name' => wp_dp_plugin_text_srt('wp_dp_member_branches_email'),
                                    'desc' => '',
                                    'echo' => true,
                                    'field_params' => array(
                                        'std' => $branch_email,
                        ...
                        <?php $this->wp_dp_frontend_location_fields('on', $branch_id, 'branch'); ?>
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="field-holder">
                                <?php
                                if ($branch_id == NULL) {
                                    $btn_label = wp_dp_plugin_text_srt('wp_dp_member_branches_add');
                                } else {
                                    $btn_label = wp_dp_plugin_text_srt('wp_dp_member_branches_update');
                                }
                                ?>
                                <a href="javascript:void(0);" id="save_branch" class="btn-send"><?php echo esc_html($btn_label); ?></a>
                                <a href = "javascript:void(0);" class="cancel"><?php echo wp_dp_plugin_text_srt('wp_dp_member_branches_cancel'); ?></a>
                            </div>
                        </div>
                    </div>
                </form>
        ...
        public function wp_dp_remove_member_branch_callback() {
            $branch_id = wp_dp_get_input('wp_dp_branch_id', NULL, 'INT');
            if ($branch_id != '' && get_post_type($branch_id) == 'branches') {
                wp_delete_post($branch_id, true);
                $response_array = array(
                    'type' => 'success',
                    'msg' => wp_dp_plugin_text_srt('wp_dp_member_branches_removed_success'),
                );
            }
            echo json_encode($response_array);
            wp_die();
         ...
         * Member Member Form
         */
        public function wp_dp_member_branches_callback($user_id = '') {
            global $wp_dp_html_fields_frontend, $post, $wp_dp_form_fields_frontend;
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="user-profile member-branches">
                        <div class="element-title">
                            <h4><?php echo wp_dp_plugin_text_srt('wp_dp_member_branches_branches') ?></h4>
                            <div class="team-option branch-option">
                                <a href="javascript:void(0);" class="add-more add_branch"><?php echo wp_dp_plugin_text_srt('wp_dp_member_branches_add_branches'); ?></a>
                            </div>
                        </div>
                        <div class="row">
                                    ...
                                    <div class="team-list">
                                        ...
                                        if (isset($branches) && !empty($branches) && sizeof($branches) > 0) {
                                            ...
                                            <ul class="panel-group">
                                                <li> 
                                                    <span><?php echo wp_dp_plugin_text_srt('wp_dp_member_branches_name'); ?></span>
                                                    <span><?php echo wp_dp_plugin_text_srt('wp_dp_member_branches_phone'); ?></span>
                                                    <span><?php echo wp_dp_plugin_text_srt('wp_dp_member_branches_email'); ?></span> 
                                                </li>
                                                <?php
                                                foreach ($branches as $branche) {
                                                    $branche_name = get_post_meta($branche, 'wp_dp_branch_name', true);
                                                    $branche_phone = get_post_meta($branche, 'wp_dp_branch_phone', true);
                                                    $branche_email = get_post_meta($branche, 'wp_dp_branch_email', true);
                                                    ?>
                                                    <li>
		...
		*/
		 public function wp_dp_member_branches_count_callback($member_id){
			...
			$custom_query_listing = new WP_Query($args);
			$post_count = $custom_query_listing->post_count;
			return $post_count;
		}
    }

    global $wp_dp_member_branches;
    $wp_dp_member_branches = new Wp_dp_Member_Branches();
}
