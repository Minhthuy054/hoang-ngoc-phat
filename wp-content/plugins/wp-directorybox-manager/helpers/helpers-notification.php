 ...
 * @return
 */
if (!class_exists('WP_DP_Plugin_Notification_Helper')) {

    class WP_DP_Plugin_Notification_Helper {
        ...
        public function __construct() {
            // Do Something here..
            $this->message = wp_dp_plugin_text_srt('wp_dp_helper_notify_no_record_found');
        }
    ...
    $wp_dp_plugin_notify = new WP_DP_Plugin_Notification_Helper();
    global $wp_dp_plugin_notify;
}