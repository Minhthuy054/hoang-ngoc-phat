...
// ^^^
    ...
    jQuery.fn.gMapsLatLonPicker = (function (readius) {
        ...
        var setPosition = function (position) {
            ...
            if (jQuery('#wp_dp__loc_bounds_rest').length !== 0 && jQuery('#wp_dp__loc_bounds_rest').val() != '') {
                var polygonCoords = jQuery('#wp_dp__loc_bounds_rest').val();
        ...
        var performSearch = function (string, silent) {
            if (string == "") {
                var postiting_lat = jQuery('#wp_dp_post_loc_latitude').val();
                var postiting_lon = jQuery('#wp_dp_post_loc_longitude').val();
            ...
            _self.vars.geocoder.geocode(
                    ...
                    function (results, status) {
                        if (status == google.maps.GeocoderStatus.OK) {
                            ...
                            wp_dp_hide_button_loader('.search-location-map');
                        } else {
                            if (!silent) {
        ...
        function reload_map_with_new_location(lat, lng) {
            ...
            document.getElementById('wp_dp_post_loc_zoom').value = _this_map.getZoom();
            ...
            google.maps.event.addListener(_this_map, 'zoom_changed', function (event) {
                jQuery(_self.vars.cssID + ".gllpZoom").val(_this_map.getZoom());
                jQuery(_self.vars.cssID).trigger("location_changed", jQuery(_self.vars.cssID));
            });
        }
        ...
        var publicfunc = {
            ...
            init: function (object) {
                ...
                jQuery(document).ready(function(){
                    //jQuery(_self.vars.cssID + ".gllpSearchButton").trigger('click'); 
                });
                ...
                jQuery(_self.vars.cssID + ".gllpSearchButton").bind("click", function () {
                    ...
                    wp_dp_show_loader('.search-location-map', '', 'button_loader', thisObj);
                    wp_dp_gl_search_map(jQuery('#post_loc_address').val());
