    ...
    jQuery.fn.gBranchesMapsLatLonPicker = (function (readius) {
        ...
        _self.params = {
            ...
            displayError: function (message) {
                alert(message);
                wp_dp_hide_button_loader(_self.vars.cssID + '.search-location-map');
            }
        };
        ...
        var performSearch = function (string, silent) {
            if (string == "") {
                var postiting_lat = jQuery(_self.vars.cssID + '#wp_dp_post_loc_latitude').val();
                var postiting_lon = jQuery(_self.vars.cssID + '#wp_dp_post_loc_longitude').val();
        ...
        var publicfunc = {
            ...
            init: function (object) {
                ...
                jQuery(_self.vars.cssID + ".gllpSearchButton").bind("click", function () {
                    ...
                    wp_dp_show_loader(_self.vars.cssID + '.search-location-map', '', 'button_loader', thisObj);
                    wp_dp_gl_search_map(jQuery(_self.vars.cssID + '#post_loc_address').val());
                    performSearch(jQuery(_self.vars.cssID + ".wp-dp-search-location").val(), false);
                });
