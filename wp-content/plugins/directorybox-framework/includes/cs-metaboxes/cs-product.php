 ...
 *
 */
add_action('add_meta_boxes', 'wp_dp_cs_meta_product_add');
if (!function_exists('wp_dp_cs_meta_product_add')) {

    function wp_dp_cs_meta_product_add() {
        global $wp_dp_cs_var_frame_static_text;
        
        add_meta_box('wp_dp_cs_meta_product', wp_dp_cs_var_frame_text_srt('wp_dp_cs_var_product_options'), 'wp_dp_cs_meta_product', 'product', 'normal', 'high');
    }
 ...
 *
 */
if (!function_exists('wp_dp_cs_meta_product')) {

    function wp_dp_cs_meta_product($post) {
        global $wp_dp_cs_var_frame_static_text;
