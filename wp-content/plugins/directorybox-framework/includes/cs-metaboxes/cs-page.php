 ...
 * @return
 */
add_action('add_meta_boxes', 'wp_dp_cs_page_options_add');

if (!function_exists('wp_dp_cs_page_options_add')) {

    function wp_dp_cs_page_options_add() {
        global $wp_dp_cs_var_frame_static_text;
        add_meta_box('id_page_options', wp_dp_cs_var_frame_text_srt('wp_dp_cs_var_page_option'), 'wp_dp_cs_page_options', 'page', 'normal', 'low');
    }
 ...
 *
 */
if (!function_exists('wp_dp_cs_page_options')) {

    function wp_dp_cs_page_options($post) {
                    ...
                    <div class="elementhidden">
                        ...
                        <div id="tabbed-content">
                            <div id="tab-general-settings">
                                ...
                                <?php wp_dp_cs_sidebar_layout_options(); ?>
                            </div>
