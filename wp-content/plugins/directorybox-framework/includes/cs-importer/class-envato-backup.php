...
if ( ! class_exists( 'Envato_Backup' ) ) {
  ...
  class Envato_Backup {
    ...
    /**
     * Helper function to sanitize the root wp_dp_cs path.
     *
     * @access    public
     * @since     1.4
     *
    ...
    /**
     * Helper function to sanitize the archive wp_dp_cs path.
     *
     * @access    public
     * @since     1.4
     *
    ...
    public function exclude_string( $context = 'zip' ) {
      ...
      foreach( $excludes as $key => &$rule ) {
        ...
        /* Wrap wp_dp_cs fragments and files in wildcards for zip */
