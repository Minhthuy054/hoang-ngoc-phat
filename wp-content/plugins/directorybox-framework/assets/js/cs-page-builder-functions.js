...
var Data = [
    {"Class": "column_100", "title": "100", "element": ["locations","newsletter","quote","wp_dp_listings","wp_dp_map_listings","dealer", "mail_chimp", "price_table", "blog_search", "blog_categories", "tweets", "tabs", "maintenance","inventory_type", "package", "team", "contact_info", "flex_column", "promobox" ,"inventories", "compare_inventories", "clients", "woo_feature", "image_frame", "flex_editor", "stylist", "heading","tabs_fancy", "video", "call_to_action", "price_services", "button", "maintenance", "listing_price", "counter", "ads", "gallery", "faq", "blog", "author" ,"map", "contact_form", "image_frame", "spacer", "accordion", "testimonial", "promobox", "list", "divider", "sitemap", "icon_box", "progressbars", "table", "schedule", "editor", "dropcap", "infobox", "faqs_fancy", "column", "about_info"]},
    {"Class": "column_75", "title": "75", "element": ["locations","newsletter","quote","wp_dp_listings","wp_dp_map_listings", "dealer", "price_table", "mail_chimp", "blog_search", "blog_categories", "tweets", "tabs", "maintenance","inventory_type", "package", "team", "contact_info", "flex_column", "promobox" ,"inventories", "compare_inventories", "clients", "woo_feature", "flex_editor", "stylist", , "heading","tabs_fancy", "video", "call_to_action", "price_services", "button", "maintenance", "listing_price", "counter", "ads", "gallery", "faq", "blog", "author" ,"map", "contact_form", "spacer", "accordion", "testimonial", "promobox", "list", "divider", "image_frame", "sitemap", "icon_box", "progressbars", "table", "schedule", "editor", "dropcap", "infobox", "faqs_fancy", "column", "about_info"]},
    {"Class": "column_67", "title": "67", "element": ["locations","newsletter","quote","wp_dp_listings","wp_dp_map_listings", "dealer", "price_table", "mail_chimp", "blog_search", "blog_categories", "tweets", "tabs", "maintenance","inventory_type", "package", "team", "contact_info", "flex_column", "promobox" ,"inventories", "compare_inventories", "clients", "woo_feature", "image_frame", "flex_editor", "stylist", "heading","tabs_fancy", "video", "call_to_action", "price_services", "button", "maintenance", "listing_price", "counter", "ads", "gallery", "faq", "blog", "author" ,"map", "contact_form", "spacer", "accordion", "testimonial", "promobox", "list", "divider", "sitemap", "icon_box", "progressbars", "table", "schedule", "editor", "dropcap", "infobox", "faqs_fancy", "column", "about_info"]},
    {"Class": "column_50", "title": "50", "element": ["locations","newsletter","quote","wp_dp_listings","wp_dp_map_listings", "dealer", "price_table", "mail_chimp", "blog_search", "blog_categories", "tweets", "tabs", "maintenance","inventory_type", "package", "team", "contact_info", "flex_column", "promobox" ,"inventories", "compare_inventories", "clients", "woo_feature", "image_frame", "flex_editor", "stylist", "heading","tabs_fancy", "video", "call_to_action", "price_services", "button", "maintenance", "listing_price", "counter", "ads", "gallery", "faq", "blog", "author" ,"map", "contact_form", "spacer", "accordion", "testimonial", "promobox", "list", "divider", "sitemap", "icon_box", "progressbars", "table", "schedule", "editor", "dropcap", "infobox", "faqs_fancy", "column", "about_info"]},
    {"Class": "column_33", "title": "33", "element": ["locations","newsletter","quote","wp_dp_listings","wp_dp_map_listings", "dealer", "price_table", "mail_chimp", "blog_search", "blog_categories", "tweets", "tabs", "maintenance","inventory_type", "package", "team", "contact_info", "flex_column", "promobox" ,"inventories", "compare_inventories", "clients", "woo_feature", "image_frame", "flex_editor", "stylist", "heading","tabs_fancy", "video", "call_to_action", "price_services", "button", "maintenance", "listing_price", "counter", "ads", "gallery", "faq", "flex_editor", "blog", "author" ,"map", "contact_form", "spacer", "accordion", "testimonial", "promobox", "list", "divider", "sitemap", "icon_box", "progressbars", "table", "schedule", "editor", "dropcap", "infobox", "faqs_fancy", "column", "about_info"]},
    {"Class": "column_25", "title": "25", "element": ["locations","newsletter","quote","wp_dp_listings","wp_dp_map_listings", "dealer", "price_table", "mail_chimp", "blog_search", "blog_categories", "tweets", "tabs", "maintenance","inventory_type", "package", "team", "contact_info", "flex_column", "promobox" ,"inventories", "compare_inventories", "clients", "woo_feature", "image_frame", "flex_editor", "stylist", "heading","tabs_fancy", "video", "call_to_action", "price_services", "button", "maintenance", "listing_price", "counter", "ads", "gallery", "faq", "blog", "author" ,"map", "contact_form", "spacer", "accordion", "testimonial", "promobox", "list", "divider", "sitemap", "icon_box", "progressbars", "table", "schedule", "editor", "dropcap", "infobox", "faqs_fancy", "column", "about_info"]},
];
...
jQuery(document).on("click", "button.notice-dismiss", function () {
    ...
    var newCustomerForm = "admin=yes&action=wp_dp_cs_admin_dismiss_notice";
    jQuery.ajax({
        type: "POST",
        url: admin_url,
...
function wp_dp_cs_page_composer_filterable(id) {
    "use strict";
...
function wp_dp_cs_frame_createpop(data, type) {
    "use strict";
...
function wp_dp_cs_frame_removeoverlay(id, text) {
    "use strict";
...
function wp_dp_cs_frame_loader() {
    "use strict";
...
function wp_dp_cs_frame_callme() {
    "use strict";
...
function wp_dp_cs_createpopshort(object) {
    var _structure = "<div id='cs-pbwp-outerlay'><div id='cs-widgets-list'></div></div>";
...
function ajax_shortcode_widget_element(object, admin_url, POSTID, name) {
    ...
    if (shortcodevalue) {
        ...
        var wp_dp_cs_random_num = Math.floor((Math.random() * 98989) + 1);

        var newCustomerForm = "action=wp_dp_cs_var_page_builder_" + name + '&counter=' + wp_dp_cs_random_num + '&shortcode_element_id=' + encodeURIComponent(shortcodevalue) + '&POSTID=' + POSTID + dcpt_element_data;
        ...
        jQuery.ajax({
            ...
            success: function (data) {
                ...
                var wp_dp_cs_close_id = object.closest(".column-in").next().find(".cs-heading-area").parent('div').attr('id');
                var wp_dp_cs_save_btn = object.closest(".column-in").next().find(".cs-wp_dp_cs-admin-btn");
                wp_dp_cs_save_btn.attr('onclick', 'javascript:wp_dp_cs_frame_removeoverlay(\'' + wp_dp_cs_close_id + '\', \'filterdrag\')');
...
function wp_dp_cs_decrement(id) {
...
function wp_dp_cs_increment(id) {
    "use strict";
    var i, c;
    var $ = jQuery;
    var parent, ColumnIndex, CurrentWidget, CurrentColumn, module;
...
function wp_dp_cs_shortcode_insert_editor(element_name, id) {
    "use strict";
    var $id = jQuery("#" + id),
            _this = jQuery(this),
            attributes = '',
...
var wp_dp_cs_shortocde_selection = (function (val, admin_url, id) {

    wp_dp_cs_frame_loader();
    jQuery("#" + id).parents('#cs-widgets-list').removeClass('wide-width');
    if (val != "") {
        var shortcode_counter = 1
        var action = "wp_dp_cs_var_page_builder_" + val;
        ...
        jQuery.ajax({
            ...
            data: newCustomerForm,
            success: function (data) {
                wp_dp_cs_fontnamesearch();
                wp_dp_cs_frame_removeoverlay(id, 'widgetitem');
                wp_dp_cs_frame_createpop(data, "csmedia");
                jQuery('.bg_color').wpColorPicker();
                jQuery('div.cs-drag-slider').each(function () {
                    var _this = jQuery(this);
                    _this.slider({
...
function wp_dp_cs_fontnamesearch() {
...
function show_sidebar(id, random_id) {
    "use strict";
    var $ = jQuery;
    jQuery('input[class="radio_wp_dp_sidebar"]').click(function () {
...
function wp_dp_cs_section_background_settings_toggle(id, rand_no) {
    "use strict";
    if (id == "no-image") {
...
function wp_dp_cs_header_element_toggle(id) {
    "use strict";

    if (id == "no-header") {
        jQuery("#wp_dp_cs_var_custom_header").hide();
        jQuery("#wp_dp_cs_var_rev_slider_header").hide();
        jQuery("#wp_dp_cs_var_map_header").hide();
        jQuery("#wp_dp_cs_var_no_header").show();
    } else if (id == "breadcrumb_header") {
        jQuery("#wp_dp_cs_var_rev_slider_header").hide();
        jQuery("#wp_dp_cs_var_map_header").hide();
        jQuery("#wp_dp_cs_var_no_header").hide();
        jQuery("#wp_dp_cs_var_custom_header").show();
    } else if (id == "custom_slider") {
        jQuery("#wp_dp_cs_var_custom_header").hide();
        jQuery("#wp_dp_cs_var_no_header").hide();
        jQuery("#wp_dp_cs_var_map_header").hide();
        jQuery("#wp_dp_cs_var_rev_slider_header").show();
    } else if (id == "map") {
        jQuery("#wp_dp_cs_var_custom_header").hide();
        jQuery("#wp_dp_cs_var_no_header").hide();
        jQuery("#wp_dp_cs_var_rev_slider_header").hide();
        jQuery("#wp_dp_cs_var_map_header").show();
    } else {
        jQuery("#wp_dp_cs_var_custom_header").hide();
        jQuery("#wp_dp_cs_var_rev_slider_header").hide();
        jQuery("#wp_dp_cs_var_map_header").hide();
...
function show_sidebar_page(id) {
    "use strict";
    var $ = jQuery;
    jQuery(document).on('click', 'input[name="wp_dp_cs_var_page_layout"]', function () {
        jQuery(this).parent().parent().find(".check-list").removeClass("check-list");
        jQuery(this).siblings("label").children("#check-list").addClass("check-list");
    });
    if (id == 'left') {
        $("#wp_dp_cs_var_right_layout").hide();
        $("#wp_dp_cs_var_left_layout").show();
        $("#wp_dp_cs_var_second_right_layout").hide();
        $("#wp_dp_cs_var_second_left_layout").hide();
    } else if (id == 'right') {
        $("#wp_dp_cs_var_right_layout").show();
        $("#wp_dp_cs_var_left_layout").hide();
        $("#wp_dp_cs_var_second_right_layout").hide();
        $("#wp_dp_cs_var_second_left_layout").hide();
        ...
        $("#wp_dp_cs_var_left_layout").show();
        $("#wp_dp_cs_var_second_right_layout").hide();
        $("#wp_dp_cs_var_second_left_layout").show();
    } else if (id == 'both_right') {
        $("#wp_dp_cs_var_right_layout").show();
        $("#wp_dp_cs_var_left_layout").hide();
        $("#wp_dp_cs_var_second_right_layout").show();
        $("#wp_dp_cs_var_second_left_layout").hide();
    } else {
        $("#wp_dp_cs_var_right_layout").hide();
        $("#wp_dp_cs_var_left_layout").hide();
...
function wp_dp_cs_shortcode_element_ajax_call(val, id, admin_url) {

    if (val != "") {
        var shortcode_counter = 1
        var action = val;
        var newCustomerForm = "shortcode_element=" + val + '&action=wp_dp_cs_shortcode_element_ajax_call';
        var options='';
        if(val=='tabs_fancy'){
            $('input[name^="wp_dp_cs_var_tabs_title"]').each(function() {
                if($(this).val()!=''){
        ...
        if(val=='faqs_fancy'){
            $('input[name^="wp_dp_cs_var_faqs_title"]').each(function() {
                if($(this).val()!=''){
                options  +='<option>'+$(this).val()+'</option>';
            }
        ...
        jQuery.ajax({
            ...
            success: function (data) {
                ...
                $('select[name^="wp_dp_cs_var_tabs_fancy_active"]').append(options);
                  $('select[name^="wp_dp_cs_var_faqs_fancy_active"]').append(options);
                jQuery('.bg_color').wpColorPicker();
                //_commonshortcode(id);
...
function wp_dp_cs_var_page_subheader_style(wp_dp_cs_value) {

    if (wp_dp_cs_value == 'with_bg') {
        $('#wp_dp_cs_var_subheader_with_bg').show();
        $('#wp_dp_cs_var_subheader_with_bc').hide();
    } else {
        $('#wp_dp_cs_var_subheader_with_bg').hide();
        $('#wp_dp_cs_var_subheader_with_bc').show();
    }
}
 ...
 *  Shortcode element ajax call function
 ...
 var shortcode_counter = 1
 var action = val;
 var newCustomerForm = "shortcode_element=" + val + '&action=wp_dp_cs_var_page_builder_testimonial';
 jQuery.ajax({
 type: "POST",
 url: admin_url,
 data: newCustomerForm,
...
function wp_dp_cs_frame_option_save(admin_url) {
    "use strict"
    jQuery(".outerwrapp-layer,.loading_div").fadeIn(100);
    function newValues() {
        var serializedValues = jQuery("#frm input,#frm select,#frm textarea[name!=wp_dp_cs_var_export_theme_options]").serialize();
 ...
 */
function wp_dp_cs_service_view_change(value) {
    "use strict";
    if (value == 'image') {
...
function wp_dp_cs_var_gallery_sorting_list(id, random_id) {
...
function wp_dp_cs_var_num_of_items(id, rand_id, numb) {
    var wp_dp_cs_var_gal_count = 0;
    jQuery("#gallery_sortable_" + rand_id + " > li").each(function (index) {
        wp_dp_cs_var_gal_count++;
        jQuery('input[name="wp_dp_cs_var_' + id + '_num"]').val(wp_dp_cs_var_gal_count);
    });

    if ( numb == '1' && numb != '' ) {
        var wp_dp_cs_var_data_temp = jQuery('#wp_dp_cs_var_' + id + '_temp');
        //if (jQuery('input[name="wp_dp_cs_' + id + '_num"]').val() == numb) {
            wp_dp_cs_var_data_temp.html('<input type="hidden" name="wp_dp_cs_var_' + id + '[]" value="">');
        //}
    }
}

function wp_dp_cs_var_createpop(data, type) {
    "use strict";
    var _structure = "<div id='cs-pbwp-outerlay'><div id='cs-widgets-list'></div></div>",
            $elem = jQuery('#cs-widgets-list');
    jQuery('body').addClass("cs-overflow");
...
function wp_dp_cs_var_remove_overlay(id, text) {
    "use strict";
    jQuery("#cs-widgets-list .loader").remove();
    var _elem1 = "<div id='cs-pbwp-outerlay'></div>",
            _elem2 = "<div id='cs-widgets-list'></div>",
...
function wp_dp_switching_editor(is_builder_active, thisObj){
    ...
    if (is_builder_active == "true") {
        ...
        formData.append('action', 'wp_dp_generate_shortcode');
         jQuery.ajax({
        ...
        jQuery("#add_page_builder_item").html("<div class='loader'><i class='icon-spinner icon-spin'></i></div>");
        //formData.append('action', 'wp_dp_generate_elements_view');
        if( typeof tinyMCE != 'undefined' && tinyMCE.activeEditor != null && tinyMCE.activeEditor != undefined ){
        ...
        var post_id = jQuery("#post_ID").val();
         jQuery.ajax({
            url : wp_dp_globals.ajax_url,
            data : 'post_id='+post_id+'&content='+content+'&action=wp_dp_generate_elements_view',
            type : 'POST',
            success : function(response){
