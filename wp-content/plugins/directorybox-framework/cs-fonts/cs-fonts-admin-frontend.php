...
if(!class_exists('wp_dp_google_fonts_admin_frontend')){
	class wp_dp_google_fonts_admin_frontend{
		
		public function wp_dp_added_google_fonts( $front = false ){
			global $wp_dp_cs_var_options;
			
			$added_google_fonts = get_option('wp_dp_added_google_fonts');
                        /*$added_google_fonts_new = array();
                        if( !empty( $added_google_fonts ) ){
                            foreach( $added_google_fonts as $key => $fontData){
                                $added_google_fonts_new[$fontData['font_family']] = $fontData;
                            }
                        }
                        
                        update_option('wp_dp_added_google_fonts', $added_google_fonts_new);
			*/
			...
			if( $front == true ){
				...
				$option_font_fields = array(
					'wp_dp_cs_var_content_font',
					'wp_dp_cs_var_mainmenu_font',
					'wp_dp_cs_var_heading1_font',
					'wp_dp_cs_var_heading2_font',
					'wp_dp_cs_var_heading3_font',
					'wp_dp_cs_var_heading4_font',
					'wp_dp_cs_var_heading5_font',
					'wp_dp_cs_var_heading6_font',
					'wp_dp_cs_var_section_title_font',
					'wp_dp_cs_var_element_title_font',
					'wp_dp_cs_var_post_title_font',
					'wp_dp_cs_var_page_title_font',
					'wp_dp_cs_var_widget_heading_font',
					'wp_dp_cs_var_ft_widget_heading_font',
				);
				foreach( $option_font_fields as $val ){
					$font_name = (isset($wp_dp_cs_var_options[$val])) ? $wp_dp_cs_var_options[$val] : '';
		...
		public function wp_dp_added_google_fonts_attributes( $front = false ){
			global $wp_dp_cs_var_options;
			...
			if( $front == true ){
				...
				foreach( $option_font_fields as $val ){
					$font_name = (isset($wp_dp_cs_var_options[$val])) ? $wp_dp_cs_var_options[$val] : '';
					$font_att = (isset($wp_dp_cs_var_options[$val .'_att'])) ? $wp_dp_cs_var_options[$val .'_att'] : '';
		...
		static function wp_dp_selected_google_fonts_attributes($id = ''){
			$added_google_fonts = get_option('wp_dp_added_google_fonts');
	...
	new wp_dp_google_fonts_admin_frontend;
}