...
if(!class_exists('wp_dp_google_fonts_frontend')){
	class wp_dp_google_fonts_frontend{
		
		public function wp_dp_added_google_fonts_subsets(){
		...
		function wp_dp_selected_google_font_print_frontend($atts = '', $size = '12', $line_height = '20', $f_name = '', $imp = false) {
			$important = '';
			$html = '';
	...
	new wp_dp_google_fonts_frontend;
}